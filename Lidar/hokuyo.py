...
#Objet Lidar ne pas appeler méthodes avec "__" devant dans le nom
class Hokuyo(object):
    SHORT_COMMAND_LEN = 5
    ...
    #Excute commande courte au Lidar et lit la réponse Lidar
    ...
    #Execute longue commande au Lidar et lit la réponse Lidar
    ...
    #Scanne une fois et renvoie dict {angle;distance}
    ...
    #Obtenir plusieurs fois distances autour du Lidar
    ...
    #Boucle de scan tant que l'état le permet
